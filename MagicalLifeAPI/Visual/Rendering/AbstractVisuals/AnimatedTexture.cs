...
namespace MagicalLifeAPI.Components.Generic.Renderable
{
    ...
    public class AnimatedTexture : AbstractVisual
    {
        ...
        public override void Render(MapBatch batch, Point2D ScreenTopLeft)
        {
            ...
            {
                batch.Draw(this.AnimationFrames.Sprites, ScreenTopLeft, this.AnimationFrames.GetSection(this.LastFrame), this.Priority);
            }
            else
            {
                ...
                batch.Draw(this.AnimationFrames.Sprites, ScreenTopLeft, this.AnimationFrames.GetSection(frame), this.Priority);
